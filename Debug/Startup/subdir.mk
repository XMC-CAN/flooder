...
Startup/%.o: ../Startup/%.S
	...
	"E:\DAVEv4\DAVE-4.1.4\eclipse\ARM-GCC-49/bin/arm-none-eabi-gcc" -x assembler-with-cpp -DXMC4700_F144x2048 -I"D:\dholler\Dokumente\uni\bus\xmc\flooder\Libraries\XMCLib\inc" -I"D:\dholler\Dokumente\uni\bus\xmc\flooder" -I"D:\dholler\Dokumente\uni\bus\xmc\flooder\Dave\Generated" -Wall -Wa,-adhlns="$@.lst" -mfloat-abi=softfp -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d) $@" -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mthumb -g -gdwarf-2 -o "$@" "$<"
